...
;; read-file para leer archivo, y string-split para separar cada string.
;(string-split (read-file archivo))
...
; (define test (write-file "prueba.html" (string-replace (read-file archivo) "\n" " <br> ")))

(define html-head (string-append "<!DOCTYPE html><html lang=\"es\"><head><meta charset=\"UTF-8\">
<title>Analizador Lexico</title><link href=\"styles.css\" rel=\"stylesheet\"></head><body>" (lexer (string-split file-br))))
(define html (string-append html-head "</body></html>"))
(define test2 (write-file "prueba2.html" html))